...
namespace CatmullClarkSubdivision
{
    ...
    private:
        ...
        const float NEW_EDGE_BETA = 3.0f / 16.0f;
        const float THREE_EIGHT = 3.0f / 8.0f;
        const float ONE_EIGHT = 1.0f / 8.0f;
        inline float calculateBeta(size_t n) { return 3.0f / ( 8.0f * n ); }
